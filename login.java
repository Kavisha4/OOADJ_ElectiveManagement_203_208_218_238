...
public class login 
{
  ...
  p1.setLayout(null);
   ...
   heading = new JLabel("PES ELECTIVE MANAGEMENT");
   ...
   login_result.setBounds(700,500,100,100);
       ...
       public void actionPerformed(ActionEvent ae)
       {
      	...
      	if ((JButton)ae.getSource()==login)
           ...
           try
           {
            ...
            con=DriverManager.getConnection("jdbc:mysql://localhost:3306/dbs_project","root","");
      	...
      	else if ((JButton)ae.getSource() == view_alloted)
      	{
      	 ...
      	 else if ((JButton)ae.getSource() == p4_logout)
      	 {
               ...
               login_result.setText("You have logged out successfully!!");
      	 }
      	//p5
